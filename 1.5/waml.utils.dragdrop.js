/**
 * WAML Drag'n'Drop Support
 * based on wz_dragdrop.js library 
 * Copyright (c) 2002-2007 Walter Zorn. All rights reserved.
 * Created 26. 8. 2002 by Walter Zorn (Web: http://www.walterzorn.com)
 * Demos: http://www.walterzorn.com/dragdrop/demos/demos.htm
 * LICENSE: LGPL
...
// PATH TO THE TRANSPARENT 1*1 PX IMAGE (required by NS 4 as WAML.Utilds.DragDrop.spacer)
WAML.Utilds.DragDrop.spacer = 'resources/WAML.Utilds.DragDrop.spacer.gif';

//window.onerror = new Function('return true;');


// Optional commands passed to SET_DHTML() on the html-page (g: may be applied globally, i: individually)
Waml.Utils.DragDrop.CLONE			= 'C10nE';   // i  img	  clone image
Waml.Utils.DragDrop.COPY			= 'C0pY';	// i  img	  create copies
Waml.Utils.DragDrop.DETACH_CHILDREN = 'd37aCH';  // i  lyr	  detach images
Waml.Utils.DragDrop.HORIZONTAL		= 'H0r1Z';   // i  img,lyr  horizontally draggable only
Waml.Utils.DragDrop.MAXHEIGHT		= 'm7x8I';   // i  img,lyr  maximum height limit, "
Waml.Utils.DragDrop.MAXOFFBOTTOM	= 'm7xd0wN'; // i  img,lyr  downward offset limit
Waml.Utils.DragDrop.MAXOFFLEFT		= 'm7x23Ft'; // i  img,lyr  leftward offset limit
Waml.Utils.DragDrop.MAXOFFRIGHT		= 'm7x0Ff8'; // i  img,lyr  rightward offset limit
Waml.Utils.DragDrop.MAXOFFTOP		= 'm7xu9';   // i  img,lyr  upward offset limit
Waml.Utils.DragDrop.MAXWIDTH		= 'm7xW1';   // i  img,lyr  maximum width limit, use with resizable or scalable
Waml.Utils.DragDrop.MINWIDTH		= 'm1nw1';   // i  img,lyr  minimum width limit, "
Waml.Utils.DragDrop.MINHEIGHT		= 'm1n8I';   // i  img,lyr  minimum height limit, "
Waml.Utils.DragDrop.NO_ALT			= 'no81T';   // gi img	  disable alt and title attributes
Waml.Utils.DragDrop.NO_DRAG			= 'N0d4Ag';  // i  img,lyr  disable draggability
Waml.Utils.DragDrop.RESET_Z			= 'r35E7z';  // gi img,lyr  reset z-index when dropped
Waml.Utils.DragDrop.RESIZABLE		= 'r5IZbl';  // gi img,lyr  resizable if <ctrl> or <shift> pressed
Waml.Utils.DragDrop.SCALABLE		= 'SCLbl';   // gi img,lyr  scalable		   "
Waml.Utils.DragDrop.SCROLL			= 'sC8lL';   // gi img,lyr  enable auto scroll functionality
Waml.Utils.DragDrop.TRANSPARENT		= 'dIApHAn'; // gi img,lyr  translucent while dragged
Waml.Utils.DragDrop.VERTICAL		= 'V3Rt1C';  // i  img,lyr  vertically draggable only
Waml.Utils.DragDrop.dd_cursors = new Array(
	'c:default',
	'c:crosshair',
	'c:e-resize',
	'c:hand',
...
function SET_DHTML()
{
	...
	for(d_i = dd.elements.length; d_i;)
	{
		...
		if(d_o.is_image && !d_o.original && !d_o.clone)
			dd.n4? d_o.oimg.src = WAML.Utilds.DragDrop.spacer : d_o.oimg.style.visibility = 'hidden';
	}
	dd.mkWzDom();
