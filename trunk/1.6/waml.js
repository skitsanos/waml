...
Waml.Browser.is_safari = function() {
    return navigator.userAgent.toLowerCase().indexOf('safari') != -1;
};
Waml.Browser.is_konq = function() {
    return navigator.userAgent.toLowerCase().indexOf('konqueror') != -1;
};
Waml.Browser.is_khtml = function() {
    return Waml.Browser.is_safari || Waml.Browser.is_konq;
};
Waml.Browser.is_ie = function() {
    return navigator.userAgent.toLowerCase().indexOf("msie") != -1;
};
Waml.Browser.is_ie7 = function() {
    return navigator.userAgent.match(/msie 7/i);
};
Waml.Browser.is_mozilla = function() {
    return navigator.userAgent.toLowerCase().indexOf("gecko") != -1;
};
Waml.Browser.is_opera = function() {
    return navigator.userAgent.match(/Opera/);
};
Waml.Browser.is_webkit = function() {
    return (navigator.userAgent.match(/AppleWebKit/));
};
Waml.Browser.is_mac = function() {
    return (navigator.platform.toString().match(/mac/i));
};
Waml.Browser.language = function() {
...
Waml.Events.detach = function(elm, event, callback) {
    ...
    for (var i = 0; i < Waml.Events.List.length; i++) {
        ...
        if (rec[0] == element && rec[1] == event && rec[2] == callback) {
            index = i;
        }
    }
    if (index != -1) {
...
Waml.Utils.defined = function(obj) {
    return typeof obj != 'undefined';
};
Waml.Utils.hex2dec = function(hex_str) {
    return parseInt(hex_str, 16);
};
Waml.Utils.dec2hex = function(num) {
...
{
    Waml.Http.open("GET", url, true, function(req) {
...
Waml.Application.warn = function(msg) {
    alert(msg);
};
Waml.Application.title = function(msg) {
